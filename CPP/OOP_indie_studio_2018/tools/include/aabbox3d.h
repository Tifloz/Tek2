    ...
    namespace core {
        ...
        */
        ...
        class aabbox3d {
            ...
            aabbox3d(const vector3d<T> &min, const vector3d<T> &max) : MinEdge(
                min), MaxEdge(max)
            {
            }
            ...
            aabbox3d(T minx, T miny, T minz, T maxx, T maxy, T maxz) : MinEdge(
                minx, miny, minz), MaxEdge(maxx, maxy, maxz)
            {
            }
            ...
            bool isPointInside(const vector3d<T> &p) const
            {
                return (p.X >= MinEdge.X && p.X <= MaxEdge.X &&
                    p.Y >= MinEdge.Y && p.Y <= MaxEdge.Y && p.Z >= MinEdge.Z &&
                    p.Z <= MaxEdge.Z);
            }
            ...
            bool intersectsWithLine(const vector3d<T> &linemiddle,
                const vector3d<T> &linevect, T halflength
            ) const
            {
