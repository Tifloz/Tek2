...
namespace irr {
    ...
    */
    extern "C" IRRLICHT_API IrrlichtDevice *IRRCALLCONV createDevice(
        ...
        const core::dimension2d<u32> &windowSize = (core::dimension2d<u32>(640,
            480)), u32 bits = 16, bool fullscreen = false,
        bool stencilbuffer = false, bool vsync = false,
    ...
    typedef IrrlichtDevice *(IRRCALLCONV *funcptr_createDevice )(
        ...
        const core::dimension2d<u32> &windowSize, u32 bits, bool fullscreen,
    ...
    //! typedef for Function Pointer
    typedef IrrlichtDevice *(IRRCALLCONV *funcptr_createDeviceEx )(
        const SIrrlichtCreationParameters &parameters
    );
