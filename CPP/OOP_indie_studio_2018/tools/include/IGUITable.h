...
namespace irr {
    namespace gui {
        ...
        const c8 *const GUIColumnOrderingNames[] = {"none", "custom", "ascend",
            "descend", "ascend_descend", 0,};
        ...
        const c8 *const GUIOrderingModeNames[] = {"none", "ascending",
            "descending", 0};
        ...
        */
        class IGUITable : public IGUIElement {
            public:
            //! constructor
            IGUITable(IGUIEnvironment *environment, IGUIElement *parent, s32 id,
            ...
            virtual void setColumnOrdering(u32 columnIndex,
            ...
            virtual void orderRows(s32 columnIndex = -1,
                EGUI_ORDERING_MODE mode = EGOM_NONE
            ) = 0;

            //! Set the text of a cell
            virtual void setCellText(u32 rowIndex, u32 columnIndex,
                const core::stringw &text
            ) = 0;

            //! Set the text of a cell, and set a color of this cell.
            virtual void setCellText(u32 rowIndex, u32 columnIndex,
                const core::stringw &text, video::SColor color
            ) = 0;
            ...
            virtual void setCellColor(u32 rowIndex, u32 columnIndex,
                video::SColor color
            ) = 0;

            //! Get the text of a cell
            virtual const wchar_t *getCellText(u32 rowIndex, u32 columnIndex
            ) const = 0;
