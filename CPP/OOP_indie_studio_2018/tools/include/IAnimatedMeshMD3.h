...
#include "irrunpack.h"
        ...
        struct SMD3QuaternionTag {
            ...
            SMD3QuaternionTag(const core::vector3df &pos,
        ...
        struct SMD3QuaternionTagList {
            ...
            SMD3QuaternionTagList &operator=(
                const SMD3QuaternionTagList &copyMe
            )
            {
        ...
        class IAnimatedMeshMD3 : public IAnimatedMesh {
            ...
            virtual SMD3QuaternionTagList *getTagList(s32 frame,
                s32 detailLevel, s32 startFrameLoop, s32 endFrameLoop
            ) = 0;
