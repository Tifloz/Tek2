        ...
        */
        class ISceneNodeAnimatorFactory : public virtual IReferenceCounted {
            ...
            virtual ISceneNodeAnimator *createSceneNodeAnimator(
                ESCENE_NODE_ANIMATOR_TYPE type, ISceneNode *target
            ) = 0;
            ...
            drop this pointer after calling this, see IReferenceCounted::drop() for details. */
            virtual ISceneNodeAnimator *createSceneNodeAnimator(
                const c8 *typeName, ISceneNode *target
            ) = 0;
            ...
            virtual ESCENE_NODE_ANIMATOR_TYPE getCreateableSceneNodeAnimatorType(
                u32 idx
            ) const = 0;
            ...
            virtual const c8 *getCreateableSceneNodeAnimatorTypeName(u32 idx
            ) const = 0;
            ...
            virtual const c8 *getCreateableSceneNodeAnimatorTypeName(
