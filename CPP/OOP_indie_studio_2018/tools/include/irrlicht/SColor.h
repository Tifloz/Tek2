    ...
    namespace video {
        ...
        inline u16 A8R8G8B8toA1R5G5B5(u32 color)
        {
            return (u16)((color & 0x80000000) >> 16 |
                (color & 0x00F80000) >> 9 | (color & 0x0000F800) >> 6 |
                (color & 0x000000F8) >> 3);
        }
        ...
        */
        class SColor {
            ...
            SColor(u32 a, u32 r, u32 g, u32 b) : color(
            ...
            SColor getInterpolated(const SColor &other, f32 d) const
            {
                ...
                return SColor(
                    (u32)core::round32(other.getAlpha() * inv + getAlpha() * d),
            ...
            \param d: value between 0.0f and 1.0f. */
            SColor getInterpolated_quadratic(const SColor &c1, const SColor &c2,
                f32 d
            ) const
            {
                ...
                return SColor(core::clamp(core::floor32(
                    getAlpha() * mul0 + c1.getAlpha() * mul1 +
                        c2.getAlpha() * mul2), 0, 255), core::clamp(
                    core::floor32(getRed() * mul0 + c1.getRed() * mul1 +
                        c2.getRed() * mul2), 0, 255), core::clamp(core::floor32(
                    getGreen() * mul0 + c1.getGreen() * mul1 +
                        c2.getGreen() * mul2), 0, 255), core::clamp(
                    core::floor32(getBlue() * mul0 + c1.getBlue() * mul1 +
        ...
        */
        class SColorf {
            ...
            {
                return SColor((u32)core::round32(a * 255.0f),
                    (u32)core::round32(r * 255.0f),
                    (u32)core::round32(g * 255.0f),
        ...
        */
        class SColorHSL {
            public:
            SColorHSL(f32 h = 0.f, f32 s = 0.f, f32 l = 0.f) : Hue(h),
        ...
        {
            const f32 maxVal = core::max_(color.getRed(), color.getGreen(),
                color.getBlue());
            const f32 minVal = (f32)core::min_(color.getRed(), color.getGreen(),
                color.getBlue());
        ...
        inline void SColorHSL::toRGB(SColorf &color) const
        {
            ...
            color.set(toRGB1(rm1, rm2, h + 1.f / 3.f), toRGB1(rm1, rm2, h),
