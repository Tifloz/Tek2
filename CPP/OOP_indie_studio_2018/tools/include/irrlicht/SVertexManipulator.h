    ...
    namespace scene {
        ...
        */
        ...
        class SVertexColorThresholdManipulator : public IVertexManipulator {
            ...
            {
                vertex.Color =
                    ((u8)vertex.Color.getAverage() > Threshold) ? High : Low;
            }
        ...
        class SVertexColorBrightnessManipulator : public IVertexManipulator {
            ...
            {
                vertex.Color.setRed(
                    core::clamp(vertex.Color.getRed() + Amount, 0u, 255u));
                vertex.Color.setGreen(
                    core::clamp(vertex.Color.getGreen() + Amount, 0u, 255u));
                vertex.Color.setBlue(
                    core::clamp(vertex.Color.getBlue() + Amount, 0u, 255u));
            }
        ...
        class SVertexColorContrastManipulator : public IVertexManipulator {
            ...
            void operator()(video::S3DVertex &vertex) const
            {
                vertex.Color.setRed(core::clamp(
                    core::round32((vertex.Color.getRed() - 128) * Factor) + 128,
                    0, 255));
                vertex.Color.setGreen(core::clamp(
                    core::round32((vertex.Color.getGreen() - 128) * Factor) +
                        128, 0, 255));
                vertex.Color.setBlue(core::clamp(
                    core::round32((vertex.Color.getBlue() - 128) * Factor) +
                        128, 0, 255));
            }
        ...
        class SVertexColorContrastBrightnessManipulator
            ...
            SVertexColorContrastBrightnessManipulator(f32 factor, s32 amount)
                : Factor(factor), Amount(amount + 128)
            {
            }
            ...
            {
                vertex.Color.setRed(core::clamp(
                    core::round32((vertex.Color.getRed() - 128) * Factor) +
                        Amount, 0, 255));
                vertex.Color.setGreen(core::clamp(
                    core::round32((vertex.Color.getGreen() - 128) * Factor) +
                        Amount, 0, 255));
        ...
        class SVertexColorGammaManipulator : public IVertexManipulator {
            ...
            {
                vertex.Color.setRed(core::clamp(
                    core::round32(powf((f32)(vertex.Color.getRed()), Gamma)), 0,
                    255));
                vertex.Color.setGreen(core::clamp(
                    core::round32(powf((f32)(vertex.Color.getGreen()), Gamma)),
                    0, 255));
                vertex.Color.setBlue(core::clamp(
                    core::round32(powf((f32)(vertex.Color.getBlue()), Gamma)),
                    0, 255));
            }
        ...
        class SVertexColorScaleManipulator : public IVertexManipulator {
            ...
            {
                vertex.Color.setRed(
                    core::clamp(core::round32(vertex.Color.getRed() * Factor),
                        0, 255));
                vertex.Color.setGreen(
                    core::clamp(core::round32(vertex.Color.getGreen() * Factor),
                        0, 255));
                vertex.Color.setBlue(
                    core::clamp(core::round32(vertex.Color.getBlue() * Factor),
                        0, 255));
            }
        ...
        class SVertexColorInterpolateLinearManipulator
            : public IVertexManipulator {
            public:
            SVertexColorInterpolateLinearManipulator(video::SColor color,
                f32 factor
        ...
        class SVertexColorInterpolateQuadraticManipulator
            : public IVertexManipulator {
            public:
            SVertexColorInterpolateQuadraticManipulator(video::SColor color1,
                video::SColor color2, f32 factor
            ...
            void operator()(video::S3DVertex &vertex) const
            {
                vertex.Color = vertex.Color.getInterpolated_quadratic(Color1,
                    Color2, Factor);
            }
        ...
        */
        ...
        class SVertexTCoordsScaleManipulator : public IVertexManipulator {
            public:
            SVertexTCoordsScaleManipulator(const core::vector2df &factor,
                u32 uvSet = 1
            ) : Factor(factor), UVSet(uvSet)
            {
            }
