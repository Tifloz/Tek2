...
namespace irr {
    namespace gui {
        ...
        const c8 *const GUICursorIconNames[
            ECI_COUNT + 1] = {"normal", "cross", "hand", "help", "ibeam", "no",
                "wait", "sizeall", "sizenesw", "sizenwse", "sizens", "sizewe",
                "sizeup", 0};
        ...
        struct SCursorSprite {
            ...
            SCursorSprite(gui::IGUISpriteBank *spriteBank, s32 spriteId,
                const core::position2d<s32> &hotspot = (core::position2d<s32>(0,
                    0))) : SpriteBank(spriteBank), SpriteId(spriteId),
                HotSpot(hotspot)
            {
            }
        ...
        class ICursorControl : public virtual IReferenceCounted {
            ...
            */
            virtual void changeIcon(ECURSOR_ICON iconId,
