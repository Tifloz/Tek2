    ...
    namespace core {
        ...
        class map {
            ...
            class RBTree {
                ...
                RBTree(const KeyTypeRB &k, const ValueTypeRB &v) : LeftChild(0),
                    RightChild(0), Parent(0), Key(k), Value(v), IsRed(true)
                {
                }
            ...
            class ConstIterator {
                ...
                // Copy constructor
                ConstIterator(const ConstIterator &src) : Root(src.Root),
                    Cur(src.Cur)
                {
                }

                ConstIterator(const Iterator &src) : Root(src.Root),
                    Cur(src.Cur)
                {
                }
            ...
            class AccessClass {
                ...
                AccessClass(map &tree, const KeyType &key) : Tree(tree),
                    Key(key)
                {
                }
