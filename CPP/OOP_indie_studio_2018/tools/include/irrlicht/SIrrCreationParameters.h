...
namespace irr {
    ...
    struct SIrrlichtCreationParameters {
        ...
        SIrrlichtCreationParameters() : DeviceType(EIDT_BEST),
            DriverType(video::EDT_BURNINGSVIDEO),
            WindowSize(core::dimension2d<u32>(800, 600)), Bits(16),
            ZBufferBits(16), Fullscreen(false), Stencilbuffer(false),
            Vsync(false), AntiAlias(0), HandleSRGB(false),
            WithAlphaChannel(false), Doublebuffer(true), IgnoreInput(false),
            Stereobuffer(false), HighPrecisionFPU(false), EventReceiver(0),
            WindowId(0),
        #ifdef _DEBUG
        ...
        #endif
            DisplayAdapter(0), DriverMultithreaded(false),
        ...
        SIrrlichtCreationParameters &operator=(
            const SIrrlichtCreationParameters &other
        )
        {
