...
namespace irr {
    namespace gui {
        ...
        class IGUIElement
            : public virtual io::IAttributeExchangingObject,
                public IEventReceiver {
            public:

            //! Constructor
            IGUIElement(EGUI_ELEMENT_TYPE type, IGUIEnvironment *environment,
                ...
                IsSubElement(false), NoClip(false), ID(id), IsTabStop(false),
                TabOrder(-1), IsTabGroup(false), AlignLeft(EGUIA_UPPERLEFT),
                AlignRight(EGUIA_UPPERLEFT), AlignTop(EGUIA_UPPERLEFT),
                AlignBottom(EGUIA_UPPERLEFT), Environment(environment),
                Type(type)
            {
                #ifdef _DEBUG
            ...
            void setRelativePosition(const core::rect<s32> &r)
            {
                if (Parent) {
                    ...
                    core::dimension2df d((f32)(r2.getSize().Width),
                        (f32)(r2.getSize().Height));

                    if (AlignLeft == EGUIA_SCALE)
                        ScaleRect.UpperLeftCorner.X =
                            (f32)r.UpperLeftCorner.X / d.Width;
                    if (AlignRight == EGUIA_SCALE)
                        ScaleRect.LowerRightCorner.X =
                            (f32)r.LowerRightCorner.X / d.Width;
                    if (AlignTop == EGUIA_SCALE)
                        ScaleRect.UpperLeftCorner.Y =
                            (f32)r.UpperLeftCorner.Y / d.Height;
                    if (AlignBottom == EGUIA_SCALE)
                        ScaleRect.LowerRightCorner.Y =
                            (f32)r.LowerRightCorner.Y / d.Height;
                }
            ...
            void setAlignment(EGUI_ALIGNMENT left, EGUI_ALIGNMENT right,
                EGUI_ALIGNMENT top, EGUI_ALIGNMENT bottom
            )
            {
                AlignLeft = left;
                AlignRight = right;
                ...
                if (Parent) {
                    ...
                    core::dimension2df d((f32)r.getSize().Width,
                        (f32)r.getSize().Height);

                    if (AlignLeft == EGUIA_SCALE)
                        ScaleRect.UpperLeftCorner.X =
                            (f32)DesiredRect.UpperLeftCorner.X / d.Width;
                    if (AlignRight == EGUIA_SCALE)
                        ScaleRect.LowerRightCorner.X =
                            (f32)DesiredRect.LowerRightCorner.X / d.Width;
                    if (AlignTop == EGUIA_SCALE)
                        ScaleRect.UpperLeftCorner.Y =
                            (f32)DesiredRect.UpperLeftCorner.Y / d.Height;
                    if (AlignBottom == EGUIA_SCALE)
                        ScaleRect.LowerRightCorner.Y =
                            (f32)DesiredRect.LowerRightCorner.Y / d.Height;
                }
            }
            ...
            void setTabOrder(s32 index)
            {
                ...
                if (index < 0) {
                    ...
                    if (el) {
                        ...
                        el->getNextElement(-1, true, IsTabGroup, first, closest,
                            true);
                        if (first) {
            ...
            */
            ...
            bool getNextElement(s32 startOrder, bool reverse, bool group,
                IGUIElement *&first, IGUIElement *&closest,
                    ...
                    if (((*it)->isVisible() || includeInvisible) &&
                        ...
                        if ((*it)->isTabStop() &&
                            ...
                            if (closest) {
                                ...
                                if ((reverse && currentOrder > closestOrder &&
                                    currentOrder < startOrder) ||
                                    (!reverse && currentOrder < closestOrder &&
                                        currentOrder > startOrder)) {
                                    closest = *it;
                                }
                            } else if ((reverse && currentOrder < startOrder) ||
                                (!reverse && currentOrder > startOrder)) {
                                closest = *it;
                            }
                            ...
                            if (first) {
                                ...
                                if ((reverse && closestOrder < currentOrder) ||
                                    (!reverse && closestOrder > currentOrder)) {
                                    first = *it;
                                }
                            } else {
                                first = *it;
                        ...
                        if ((*it)->getNextElement(startOrder, reverse, group,
                            first, closest)) {
                            _IRR_IMPLEMENT_MANAGED_MARSHALLING_BUGFIX;
                            return true;
                        }
            ...
            */
            ...
            ) const
            {
                ...
                out->addPosition2d("MinSize",
                    core::position2di(MinSize.Width, MinSize.Height));
                out->addPosition2d("MaxSize",
                    core::position2di(MaxSize.Width, MaxSize.Height));
            ...
            )
            {
                ...
                setAlignment(
                    (EGUI_ALIGNMENT)in->getAttributeAsEnumeration("LeftAlign",
                        GUIAlignmentNames),
                    (EGUI_ALIGNMENT)in->getAttributeAsEnumeration("RightAlign",
                        GUIAlignmentNames),
                    (EGUI_ALIGNMENT)in->getAttributeAsEnumeration("TopAlign",
                        GUIAlignmentNames),
                    (EGUI_ALIGNMENT)in->getAttributeAsEnumeration("BottomAlign",
                        GUIAlignmentNames));
            ...
            void recalculateAbsolutePosition(bool recursive)
            {
                ...
                const s32 diffy =
                    parentAbsolute.getHeight() - LastParentRect.getHeight();
                ...
                case EGUIA_CENTER:
                    ...
                    break;
                case EGUIA_SCALE:
                    DesiredRect.UpperLeftCorner.X = core::round32(
                        ScaleRect.UpperLeftCorner.X * fw);
                    break;
                }
                ...
                case EGUIA_CENTER:
                    ...
                    break;
                case EGUIA_SCALE:
                    DesiredRect.LowerRightCorner.X = core::round32(
                        ScaleRect.LowerRightCorner.X * fw);
                    break;
                }
                ...
                case EGUIA_CENTER:
                    ...
                    break;
                case EGUIA_SCALE:
                    DesiredRect.UpperLeftCorner.Y = core::round32(
                        ScaleRect.UpperLeftCorner.Y * fh);
                    break;
                }
                ...
                case EGUIA_CENTER:
                    ...
                    break;
                case EGUIA_SCALE:
                    DesiredRect.LowerRightCorner.Y = core::round32(
                        ScaleRect.LowerRightCorner.Y * fh);
                    break;
                }
                ...
                if (w < (s32)MinSize.Width)
                    RelativeRect.LowerRightCorner.X =
                        RelativeRect.UpperLeftCorner.X + MinSize.Width;
                if (h < (s32)MinSize.Height)
                    RelativeRect.LowerRightCorner.Y =
                        RelativeRect.UpperLeftCorner.Y + MinSize.Height;
                if (MaxSize.Width && w > (s32)MaxSize.Width)
                    RelativeRect.LowerRightCorner.X =
                        RelativeRect.UpperLeftCorner.X + MaxSize.Width;
                if (MaxSize.Height && h > (s32)MaxSize.Height)
                    RelativeRect.LowerRightCorner.Y =
                        RelativeRect.UpperLeftCorner.Y + MaxSize.Height;
