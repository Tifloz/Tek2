...
namespace irr {
    ...
    namespace scene {
        ...
        class IColladaMeshWriterProperties : public virtual IReferenceCounted {
            ...
            virtual E_COLLADA_TECHNIQUE_FX getTechniqueFx(
            ...
            virtual s32 getTextureIdx(const video::SMaterial &material,
            ...
            virtual f32 getTransparency(const video::SMaterial &material
            ) const = 0;
            ...
            virtual f32 getReflectivity(const video::SMaterial &material
            ) const = 0;
            ...
            virtual f32 getIndexOfRefraction(const video::SMaterial &material
            ) const = 0;
            ...
            virtual bool isExportable(const irr::scene::ISceneNode *node
            ) const = 0;
            ...
            virtual bool useNodeMaterial(const scene::ISceneNode *node
            ) const = 0;
        };
        ...
        */
        class IColladaMeshWriterNames : public virtual IReferenceCounted {
            ...
            */
            ...
            IColladaMeshWriter::toNCName to ensure that.
            */
            virtual irr::core::stringw nameForNode(
            ...
            */
            virtual irr::core::stringw nameForMaterial(
                const video::SMaterial &material, int materialId,
                const scene::IMesh *mesh, const scene::ISceneNode *node
            ) = 0;
        };
        ...
        class IColladaMeshWriter : public IMeshWriter {
            ...
            IColladaMeshWriter() : Properties(0), DefaultProperties(0),
                NameGenerator(0), DefaultNameGenerator(0), WriteTextures(true),
                WriteDefaultScene(true), ExportSMaterialOnce(true),
                AmbientLight(0.f, 0.f, 0.f, 1.f), GeometryWriting(ECGI_PER_MESH)
            {
            }
            ...
            virtual bool writeScene(io::IWriteFile *file,
            ...
            */
            virtual void setGeometryWriting(
                E_COLLADA_GEOMETRY_WRITING writeStyle
            )
            {
            ...
            */
            ...
            virtual irr::core::stringw toNCName(
                const irr::core::stringw &oldString,
                const irr::core::stringw &prefix = irr::core::stringw(
                    L"_NC_")) const = 0;
