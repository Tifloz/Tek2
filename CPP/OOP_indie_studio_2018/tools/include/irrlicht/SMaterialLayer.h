...
namespace irr {
    namespace video {
        ...
        static const char *const aTextureClampNames[] = {"texture_clamp_repeat",
            "texture_clamp_clamp", "texture_clamp_clamp_to_edge",
            "texture_clamp_clamp_to_border", "texture_clamp_mirror",
            "texture_clamp_mirror_clamp", "texture_clamp_mirror_clamp_to_edge",
        ...
        class SMaterialLayer {
            public:
            //! Default constructor
            SMaterialLayer() : Texture(0), TextureWrapU(ETC_REPEAT),
                TextureWrapV(ETC_REPEAT), BilinearFilter(true),
                TrilinearFilter(false), AnisotropicFilter(0), LODBias(0),
                TextureMatrix(0)
            {
            }
            ...
            {
                bool different =
                    Texture != b.Texture || TextureWrapU != b.TextureWrapU ||
                ...
                if (different)
                    ...
                    different |=
                        (TextureMatrix != b.TextureMatrix) && TextureMatrix &&
                            b.TextureMatrix &&
