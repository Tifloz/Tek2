        ...
        class ISceneNode : virtual public io::IAttributeExchangingObject {
            ...
            ISceneNode(ISceneNode *parent, ISceneManager *mgr, s32 id = -1,
                ...
                const core::vector3df &scale = core::vector3df(1.0f, 1.0f,
                    1.0f)) : RelativeTranslation(position),
                RelativeRotation(rotation), RelativeScale(scale), Parent(0),
            ...
            */
            ...
            )
            {
                ...
                if (tmpState != -1)
                    ...
                    AutomaticCullingState = in->getAttributeAsInt(
                        "AutomaticCulling");
            ...
            void cloneMembers(ISceneNode *toCopyFrom, ISceneManager *newManager)
            {
                ...
                for (; ait != toCopyFrom->Animators.end(); ++ait) {
                    ISceneNodeAnimator *anim = (*ait)->createClone(this,
                        SceneManager);
                    if (anim) {
                        addAnimator(anim);
                        anim->drop();
