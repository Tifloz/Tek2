...
namespace irr {
    ...
    namespace gui {
        ...
        class IGUIToolBar : public IGUIElement {
            ...
            //! constructor
            IGUIToolBar(IGUIEnvironment *environment, IGUIElement *parent,
            ...
            virtual IGUIButton *addButton(s32 id = -1, const wchar_t *text = 0,
                const wchar_t *tooltiptext = 0, video::ITexture *img = 0,
                video::ITexture *pressedimg = 0, bool isPushButton = false,
