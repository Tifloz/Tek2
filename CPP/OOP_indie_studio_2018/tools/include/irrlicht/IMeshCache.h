...
namespace irr {
    ...
    namespace scene {
        ...
        class IMeshCache : public virtual IReferenceCounted {
            ...
            Irrlicht 1.9 */
            _IRR_DEPRECATED_ IAnimatedMesh *getMeshByFilename(
            ...
            /** \deprecated Use getMeshName() instead. This method may be removed by
            Irrlicht 1.9 */
            _IRR_DEPRECATED_ const io::path &getMeshFilename(
            ...
            Irrlicht 1.9 */
            _IRR_DEPRECATED_ bool setMeshFilename(u32 index,
                const io::path &filename
            )
            {
            ...
            /** \deprecated Use renameMesh() instead. This method may be removed by
            Irrlicht 1.9 */
            _IRR_DEPRECATED_ bool setMeshFilename(const IMesh *const mesh,
                const io::path &filename
            )
            {
            ...
            \return The name if mesh was found and has a name, else	the path is empty. */
            virtual const io::SNamedPath &getMeshName(const IMesh *const mesh
            ) const = 0;
            ...
            \param name New name for the mesh.
            \return True if mesh was renamed. */
            virtual bool renameMesh(const IMesh *const mesh,
                const io::path &name
            ) = 0;
