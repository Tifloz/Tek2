    ...
    namespace core {
        ...
        class quaternion {
            ...
            void getMatrix(matrix4 &dest,
                const core::vector3df &translation = core::vector3df()) const;
            ...
            */
            void getMatrixCenter(matrix4 &dest, const core::vector3df &center,
        ...
        */
        ...
        //! returns if this quaternion equals the other one, taking floating point rounding errors into account
        inline bool quaternion::equals(const quaternion &other,
            const f32 tolerance
        ) const
        {
        ...
        inline quaternion &quaternion::lerp(quaternion q1, quaternion q2,
            f32 time
        )
        {
        ...
        inline void quaternion::toAngleAxis(f32 &angle, core::vector3df &axis
        ) const
        {
