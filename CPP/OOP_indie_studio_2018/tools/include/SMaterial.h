...
namespace irr {
    namespace video {
        ...
        inline f32 pack_textureBlendFunc(const E_BLEND_FACTOR srcFact,
        ...
        {
            const u32 tmp =
                (alphaSource << 12) | (modulate << 8) | (srcFact << 4) |
                    dstFact;
            return FR(tmp);
        }
        ...
        inline void unpack_textureBlendFunc(E_BLEND_FACTOR &srcFact,
            E_BLEND_FACTOR &dstFact, E_MODULATE_FUNC &modulo, u32 &alphaSource,
            const f32 param
        )
        {
        ...
        */
        ...
        class SMaterial {
            ...
            SMaterial() : MaterialType(EMT_SOLID),
                ...
                MaterialTypeParam(0.0f), MaterialTypeParam2(0.0f),
                ...
                Lighting(true), ZWriteEnable(true), BackfaceCulling(true),
                FrontfaceCulling(false), FogEnable(false),
            ...
            inline bool operator!=(const SMaterial &b) const
            {
                ...
                for (u32 i = 0;
                    (i < MATERIAL_MAX_TEXTURES) && !different; ++i) {
