...
namespace irr {
    ...
    namespace scene {
        ...
        class ITerrainSceneNode : public ISceneNode {
            ...
            virtual const core::aabbox3d<f32> &getBoundingBox(s32 patchX,
                s32 patchZ
            ) const = 0;
            ...
            virtual void getMeshBufferForLOD(IDynamicMeshBuffer &mb,
                s32 LOD = 0
            ) const = 0;
            ...
            \param vertexColor Color of all vertices.
            \param smoothFactor Number of smoothing passes. */
            virtual bool loadHeightMapRAW(io::IReadFile *file,
                s32 bitsPerPixel = 16, bool signedData = false,
                bool floatVals = false, s32 width = 0,
                video::SColor vertexColor = video::SColor(255, 255, 255, 255),
                s32 smoothFactor = 0
            ) = 0;
        };
