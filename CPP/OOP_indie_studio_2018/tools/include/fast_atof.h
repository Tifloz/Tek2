...
namespace irr {
    namespace core {
        ...
        const float fast_atof_table[17] = {0.f, 0.1f, 0.01f, 0.001f, 0.0001f,
            0.00001f, 0.000001f, 0.0000001f, 0.00000001f, 0.000000001f,
            0.0000000001f, 0.00000000001f, 0.000000000001f, 0.0000000000001f,
            0.00000000000001f, 0.000000000000001f, 0.0000000000000001f};
        ...
        */
        inline u32 strtoul_prefix(const char *in, const char **out = 0)
        {
            ...
            if ('0' == in[0])
                return ('x' == in[1] ? strtoul16(in + 2, out) :
                    strtoul8(in + 1, out));
