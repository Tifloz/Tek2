    ...
    namespace gui {
        ...
        */
        class IGUIElementFactory : public virtual IReferenceCounted {
            ...
            virtual IGUIElement *addGUIElement(EGUI_ELEMENT_TYPE type,
            ...
            \return Pointer to the new element or null if not successful. */
            virtual IGUIElement *addGUIElement(const c8 *typeName,
                IGUIElement *parent = 0
            ) = 0;
            ...
            virtual const c8 *getCreateableGUIElementTypeName(
