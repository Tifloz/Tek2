...
namespace irr {
    ...
    namespace gui {
        ...
        const c8 *const GUIButtonStateNames[] = {"buttonUp", "buttonDown",
            "buttonMouseOver", "buttonMouseOff", "buttonFocused",
            "buttonNotFocused", 0, 0,};
        ...
        */
        class IGUIButton : public IGUIElement {
            ...
            //! constructor
            IGUIButton(IGUIEnvironment *environment, IGUIElement *parent,
