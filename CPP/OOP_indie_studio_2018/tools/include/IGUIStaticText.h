...
namespace irr {
    namespace gui {
        ...
        class IGUIStaticText : public IGUIElement {
            ...
            //! constructor
            IGUIStaticText(IGUIEnvironment *environment, IGUIElement *parent,
                s32 id, core::rect<s32> rectangle
            ) : IGUIElement(EGUIET_STATIC_TEXT, environment, parent, id,
                rectangle)
            {
            }
            ...
            virtual void setTextAlignment(EGUI_ALIGNMENT horizontal,
