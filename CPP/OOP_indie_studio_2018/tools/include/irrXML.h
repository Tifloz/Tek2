    ...
    namespace io {
        ...
        */
        ...
        class IIrrXMLReader : public super_class {
            ...
            virtual const char_type *getAttributeValue(const char_type *name
            ) const = 0;
            ...
            virtual float getAttributeValueAsFloat(const char_type *name
            ) const = 0;
        ...
        IRRLICHT_API IrrXMLReader *IRRCALLCONV createIrrXMLReader(
            const char *filename
        );
        ...
        and the file could not be opened. */
        IRRLICHT_API IrrXMLReader *IRRCALLCONV createIrrXMLReader(
            IFileReadCallBack *callback, bool deleteCallback = false
        );
        ...
        deleted using 'delete' after no longer needed. Returns 0 if an error occured
        and the file could not be opened. */
        IRRLICHT_API IrrXMLReaderUTF16 *IRRCALLCONV createIrrXMLReaderUTF16(
            const char *filename
        );
