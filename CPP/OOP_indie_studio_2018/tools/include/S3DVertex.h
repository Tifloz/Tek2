...
namespace irr {
    namespace video {
        ...
        const char *const sBuiltInVertexTypeNames[] = {"standard", "2tcoords",
            "tangents", 0};
        ...
        struct S3DVertex {
            ...
            //! constructor
            S3DVertex(f32 x, f32 y, f32 z, f32 nx, f32 ny, f32 nz, SColor c,
                f32 tu, f32 tv
        ...
        */
        struct S3DVertex2TCoords : public S3DVertex {
            ...
            S3DVertex2TCoords(f32 x, f32 y, f32 z, SColor c, f32 tu, f32 tv,
                f32 tu2, f32 tv2
            ...
            S3DVertex2TCoords(const core::vector3df &pos,
                const core::vector3df &normal, const SColor &color,
                const core::vector2d<f32> &tcoords,
                const core::vector2d<f32> &tcoords2
            ...
            //! constructor with all values
            S3DVertex2TCoords(f32 x, f32 y, f32 z, f32 nx, f32 ny, f32 nz,
            ...
            //! constructor with the same texture coords and normal
            S3DVertex2TCoords(const core::vector3df &pos,
                const core::vector3df &normal, SColor color,
                const core::vector2d<f32> &tcoords
            ...
            {
                return ((static_cast<S3DVertex>(*this) < other) ||
                    ((static_cast<S3DVertex>(*this) == other) &&
                        (TCoords2 < other.TCoords2)));
            }
            ...
            S3DVertex2TCoords getInterpolated(const S3DVertex2TCoords &other,
                f32 d
            )
            {
                d = core::clamp(d, 0.0f, 1.0f);
        ...
        struct S3DVertexTangents : public S3DVertex {
            ...
            //! constructor
            S3DVertexTangents(f32 x, f32 y, f32 z, f32 nx = 0.0f, f32 ny = 0.0f,
                f32 nz = 0.0f, SColor c = 0xFFFFFFFF, f32 tu = 0.0f,
                f32 tv = 0.0f, f32 tanx = 0.0f, f32 tany = 0.0f,
                f32 tanz = 0.0f, f32 bx = 0.0f, f32 by = 0.0f, f32 bz = 0.0f
            ...
            S3DVertexTangents(const core::vector3df &pos,
                ...
                : S3DVertex(pos, normal, c, tcoords), Tangent(tangent),
                Binormal(binormal)
            {
            }
            ...
            S3DVertexTangents getInterpolated(const S3DVertexTangents &other,
                f32 d
            )
            {
                d = core::clamp(d, 0.0f, 1.0f);
