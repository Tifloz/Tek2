...
namespace irr {
    ...
    namespace scene {
        ...
        class IGeometryCreator : public IReferenceCounted {
            ...
            */
            virtual IMesh *createCubeMesh(
                const core::vector3df &size = core::vector3df(5.f, 5.f,
                    5.f)) const = 0;
            ...
            */
            IMesh *createPlaneMesh(const core::dimension2d<f32> &tileSize,
                const core::dimension2d<u32> &tileCount = core::dimension2du(1,
                    1), video::SMaterial *material = 0,
                const core::dimension2df &textureRepeatCount = core::dimension2df(
                    1.f, 1.f)) const
            {
                return createHillPlaneMesh(tileSize, tileCount, material, 0.f,
            ...
            */
            virtual IMesh *createArrowMesh(const u32 tesselationCylinder = 4,
                ...
                const f32 widthCylinder = 0.05f, const f32 widthCone = 0.3f,
            ...
            */
            virtual IMesh *createSphereMesh(f32 radius = 5.f,
                u32 polyCountX = 16, u32 polyCountY = 16
            ) const = 0;
            ...
            */
            ...
            \return Generated mesh.
            */
            virtual IMesh *createConeMesh(f32 radius, f32 length,
                u32 tesselation,
            ...
            \return Generated mesh.
            */
            virtual IMesh *createVolumeLightMesh(const u32 subdivideU = 32,
                ...
                const core::vector3df &lightDim = core::vector3df(1.f, 1.2f,
                    1.f)) const = 0;
        };
    } // end namespace scene
} // end namespace irr
