    ...
    namespace core {
        ...
        */
        ...
        class plane3d {
            ...
            void setPlane(const vector3d<T> &point1, const vector3d<T> &point2,
                const vector3d<T> &point3
            )
            {
            ...
            */
            ...
            {
                return (
                    getIntersectionWithLine(linePoint1, linePoint2 - linePoint1,
                        outIntersection) &&
            ...
            bool getIntersectionWithPlane(const plane3d<T> &other,
                vector3d<T> &outLinePoint, vector3d<T> &outLineVect
            ) const
            {
            ...
            bool getIntersectionWithPlanes(const plane3d<T> &o1,
                const plane3d<T> &o2, vector3d<T> &outPoint
            ) const
            {
