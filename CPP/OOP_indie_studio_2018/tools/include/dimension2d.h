...
namespace irr {
    namespace core {
        ...
        class dimension2d {
            ...
            dimension2d(const T &width, const T &height) : Width(width),
                Height(height)
            {
            }
            ...
            dimension2d<T> getOptimalSize(bool requirePowerOfTwo = true,
                bool requireSquare = false, bool larger = true, u32 maxValue = 0
            ) const
            {
                u32 i = 1;
                u32 j = 1;
            ...
            dimension2d<T> getInterpolated(const dimension2d<T> &other, f32 d
            ) const
            {
                f32 inv = (1.0f - d);
                return dimension2d<T>((T)(other.Width * inv + Width * d),
