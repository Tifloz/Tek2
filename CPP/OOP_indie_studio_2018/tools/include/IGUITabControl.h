...
namespace irr {
    namespace gui {
        ...
        class IGUITab : public IGUIElement {
            ...
            //! constructor
            IGUITab(IGUIEnvironment *environment, IGUIElement *parent, s32 id,
        ...
        */
        class IGUITabControl : public IGUIElement {
            ...
            //! constructor
            IGUITabControl(IGUIEnvironment *environment, IGUIElement *parent,
                s32 id, core::rect<s32> rectangle
            ) : IGUIElement(EGUIET_TAB_CONTROL, environment, parent, id,
                rectangle)
            {
            }
            ...
            virtual IGUITab *insertTab(s32 idx, const wchar_t *caption,
                s32 id = -1
            ) = 0;
