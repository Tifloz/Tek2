...
if [[ ${error} -ne 0 ]]
then
    echo -e "\033[31mYou don't have all files needed to launch the program, try to correct your internet connection and retry\033[0m"
